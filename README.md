...
- Design a **scalable CI/CD pipeline** using GitHub Actions
- Apply **DRY principles** using Terraform modules
- Support **multiple environments** (dev, qa, stg, prd)
- Integrate **static code and security scanning**
- Demonstrate **PR-based workflows and quality gates**
